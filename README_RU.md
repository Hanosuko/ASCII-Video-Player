...
Официальный выпуск V5: конвертация видео и изображений в ASCII через JSON-конфиг, поддержка разных входных форматов, усиленный vivid-цвет и сохранение звука в видео.
...
- **🎨 Режимы цвета**: Обычный цвет, яркий vivid-цвет с усиленной насыщенностью или черно-белый ASCII.
...
```json
{
  ...
  "color": true,
  "color_style": "normal",
  "vivid_saturation": 1.75,
  "vivid_brightness": 1.15,
  "background": "#000000",
  "foreground": "#FFFFFF",
  "font_size": 10,
  "skip_frames": 1,
...
В окне можно выбрать фото или видео, настроить обычный цвет, vivid-цвет или чёрно-белый режим, ширину ASCII, размер шрифта, сохранение звука и формат экспорта.
...
Яркий насыщенный режим:

```bash
python3 ASCII_v5_official.py --input Video_temp/data.mov --width 140 --vivid-color
```
...
- `color_style`: `normal`, `vivid` или `mono`. `vivid` делает цвета ярче и насыщеннее.
- `vivid_saturation`: сила насыщенности в vivid-режиме.
- `vivid_brightness`: сила яркости в vivid-режиме.
